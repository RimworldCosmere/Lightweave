...
public static class Popover {
    public static LightweaveNode Create(
        ...
        [DocParam("Whether to render the drop shadow beneath the popover.")]
        ...
        node.Paint = (rect, paintChildren) => {
            ...
            Action drawOverlay = () => {
                ...
                using (TintScope.Replace(Color.white)) {
                    ...
                    PaintBox.Draw(popoverRect, null, border, RadiusSpec.All(RadiusScale.Lg));
                }
    ...
    private static LightweaveNode BuildPawnCardDemo() {
        ...
        LightweaveNode stormlight = Stack.Create(
            ...
            s => {
                ...
                s.Add(ProgressBar.Create(412f, 0f, 1000f, variant: ProgressBarVariant.Accent));
            }
        );
