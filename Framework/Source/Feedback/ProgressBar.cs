...
public static class ProgressBar {
    public static LightweaveNode Create(
        ...
        ProgressBarVariant variant = ProgressBarVariant.Accent,
        Style? style = null,
        string[]? classes = null,
        string? id = null,
        ...
        node.Paint = (rect, paintChildren) => {
            ...
            if (hasFill) {
                ...
                BackgroundSpec fillBg = BackgroundSpec.Of(FillSlot(variant));
    ...
    private static ThemeSlot FillSlot(ProgressBarVariant variant) {
        switch (variant) {
            case ProgressBarVariant.Accent: return ThemeSlot.SurfaceAccent;
            case ProgressBarVariant.Warning: return ThemeSlot.StatusWarning;
            case ProgressBarVariant.Danger: return ThemeSlot.StatusDanger;
            case ProgressBarVariant.Success: return ThemeSlot.StatusSuccess;
            default: return ThemeSlot.SurfaceRaised;
        }
    }

    private static ThemeSlot LabelSlot(ProgressBarVariant variant) {
        return variant == ProgressBarVariant.Neutral ? ThemeSlot.TextPrimary : ThemeSlot.TextOnAccent;
    }
    ...
    public static DocSample DocsNeutral() {
        return new DocSample(() => ProgressBar.Create(0.4f, 0f, 1f, "40%", variant: ProgressBarVariant.Neutral));
    }

    [DocVariant("CL_Playground_Label_Warning")]
    public static DocSample DocsWarning() {
        return new DocSample(() => ProgressBar.Create(0.75f, 0f, 1f, "75%", variant: ProgressBarVariant.Warning));
    }

    [DocVariant("CL_Playground_Label_Default")]
    public static DocSample DocsSuccess() {
        return new DocSample(() => ProgressBar.Create(0.35f, 0f, 1f, "35%", ProgressBarVariant.Success));
    }

    [DocVariant("CL_Playground_Label_Danger")]
    public static DocSample DocsDanger() {
        return new DocSample(() => ProgressBar.Create(0.9f, 0f, 1f, "90%", ProgressBarVariant.Danger));
    }
