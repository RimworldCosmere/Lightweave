            ...
            Action drawToasts = () => {
                for (int i = 0; i < count; i++) {
                    ...
                    using (TintScope.Multiply(new Color(1f, 1f, 1f, alpha))) {
                        ...
                        PaintBox.Draw(toastRect, bg, border, RadiusSpec.All(RadiusScale.Md));
                        ...
                        RadiusSpec stripRadius = dir == Direction.Ltr
                            ? RadiusSpec.Left(RadiusScale.Md)
                            : RadiusSpec.Right(RadiusScale.Md);
                        PaintBox.Draw(stripRect, BackgroundSpec.Of(stripColor), null, stripRadius);
