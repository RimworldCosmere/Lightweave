...
public static class ScadrialTheme {
    public static Theme Build(Font body, Font bodyBold, Font heading, Font display, Font mono, Font monoBold) {
        Dictionary<ThemeSlot, Color> colors = new Dictionary<ThemeSlot, Color> {
            ...
            [ThemeSlot.BorderFaint] = new Color(0.722f, 0.753f, 0.800f, 0.16f),
            ...
            [ThemeSlot.StatusWarningSoft] = new Color(0.831f, 0.643f, 0.216f, 0.12f),
            [ThemeSlot.StatusDangerSoft] = new Color(0.659f, 0.149f, 0.165f, 0.12f),
            [ThemeSlot.StatusSuccessSoft] = new Color(0.353f, 0.533f, 0.439f, 0.12f),
            [ThemeSlot.StatusInfoSoft] = new Color(0.482f, 0.302f, 0.541f, 0.12f),
