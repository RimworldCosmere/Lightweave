...
public static class RosharTheme {
    public static Theme Build(Font body, Font bodyBold, Font heading, Font display, Font mono, Font monoBold) {
        Dictionary<ThemeSlot, Color> colors = new Dictionary<ThemeSlot, Color> {
            ...
            [ThemeSlot.BorderFaint] = new Color(0.110f, 0.133f, 0.188f, 0.09f),
            ...
            [ThemeSlot.StatusWarningSoft] = new Color(0.627f, 0.486f, 0.243f, 0.10f),
            [ThemeSlot.StatusDangerSoft] = new Color(0.604f, 0.239f, 0.200f, 0.10f),
            [ThemeSlot.StatusSuccessSoft] = new Color(0.302f, 0.451f, 0.333f, 0.10f),
            [ThemeSlot.StatusInfoSoft] = new Color(0.290f, 0.365f, 0.514f, 0.10f),
            ...
            [ThemeSlot.SurfaceTooltip] = new Color(0.831f, 0.812f, 0.753f, 1.00f),
            [ThemeSlot.BorderTooltip] = new Color(0.373f, 0.769f, 0.824f, 1f),
            [ThemeSlot.DividerFaint] = new Color(0.110f, 0.133f, 0.188f, 0.16f),
            [ThemeSlot.Glass1] = new Color(0.847f, 0.831f, 0.776f, 0.55f),
            [ThemeSlot.Glass2] = new Color(0.831f, 0.812f, 0.753f, 0.85f),
            [ThemeSlot.Glass3] = new Color(0.831f, 0.812f, 0.753f, 0.60f),
            [ThemeSlot.WindowGlass] = new Color(0.831f, 0.812f, 0.753f, 0.92f),
