...
public static class CosmereTheme {
    public static Theme Build(Font body, Font bodyBold, Font heading, Font display, Font mono, Font monoBold) {
        Dictionary<ThemeSlot, Color> colors = new Dictionary<ThemeSlot, Color> {
            ...
            [ThemeSlot.BorderFaint] = new Color(0.627f, 0.604f, 0.525f, 0.50f),
            ...
            [ThemeSlot.StatusWarningSoft] = new Color(0.722f, 0.573f, 0.227f, 0.10f),
            [ThemeSlot.StatusDangerSoft] = new Color(0.557f, 0.133f, 0.192f, 0.10f),
            [ThemeSlot.StatusSuccessSoft] = new Color(0.290f, 0.420f, 0.361f, 0.10f),
            [ThemeSlot.StatusInfoSoft] = new Color(0.239f, 0.353f, 0.471f, 0.10f),
            ...
            [ThemeSlot.SurfaceTooltip] = new Color(0.890f, 0.875f, 0.816f, 1.00f),
            [ThemeSlot.BorderTooltip] = new Color(0.722f, 0.573f, 0.227f, 0.45f),
            [ThemeSlot.DividerFaint] = new Color(0.627f, 0.604f, 0.525f, 0.16f),
            [ThemeSlot.Glass1] = new Color(0.953f, 0.925f, 0.847f, 0.55f),
            [ThemeSlot.Glass2] = new Color(0.890f, 0.875f, 0.816f, 0.85f),
            [ThemeSlot.Glass3] = new Color(0.890f, 0.875f, 0.816f, 0.60f),
            [ThemeSlot.WindowGlass] = new Color(0.890f, 0.875f, 0.816f, 0.92f),
