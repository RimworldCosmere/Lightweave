...
public static class KeyValue {
    public static LightweaveNode Create(
        ...
        Rem? gap = null,
        [DocParam("Style override for the label gutter text. Defaults to FontRole.Label.", TypeOverride = "Style?", DefaultOverride = "null")]
        ...
        LightweaveNode labelNode = Text.Create(label, style: labelStyle ?? new Style { FontFamily = FontRole.Label });
