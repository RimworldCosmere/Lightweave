...
public static class SaveSidecar {
    ...
    public static SaveSidecarData? Read(string saveFilePath) {
        ...
        try {
            ...
            RedesignLog.Warning("SaveSidecar read failed for " + path + ": " + ex.Message);
            return null;
        }
    }
    ...
    public static void Write(string saveFilePath, SaveSidecarData data) {
        ...
        try {
            ...
            RedesignLog.Warning("SaveSidecar write failed for " + path + ": " + ex.Message);
        }
    }
    ...
    public static void Delete(string saveFilePath) {
        ...
        if (File.Exists(path)) {
            try {
                ...
                RedesignLog.Warning("SaveSidecar delete failed for " + path + ": " + ex.Message);
            }
        }
    }
